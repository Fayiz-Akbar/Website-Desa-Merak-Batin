...
<head>
    ...
    <title>Kelola Potensi - Merak Batin</title>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-8 border-end">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_potensi" id="nama_potensi" class="form-control form-control-lg bg-light border-0" placeholder="Misal: Kerajinan Tapis Merak Batin" required>
                            </div>
                            <div class="mb-3">
