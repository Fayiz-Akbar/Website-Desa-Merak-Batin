            ...
            <div class="form-card">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <textarea name="visi" class="form-control" rows="5" placeholder="Tujuan besar desa..."><?php echo $data['visi']; ?></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Misi</label>
                        <textarea name="misi" class="form-control" rows="5" placeholder="Langkah-langkah pencapaian visi..."><?php echo $data['misi']; ?></textarea>
                    </div>
                </div>
